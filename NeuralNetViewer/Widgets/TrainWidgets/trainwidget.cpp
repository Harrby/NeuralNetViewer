    ...
    m_status_widget(new TrainStatusWidget(this))
{
    ...
    connect(m_train_button, &IconButton::clicked, this, &TrainWidget::onTrainButtonClicked);
    connect(m_cancel_button, &IconButton::clicked, this, &TrainWidget::cancelButtonClicked);
}


void TrainWidget::onTrainButtonClicked(){
    m_status_widget->clearData();
    emit trainButtonClicked();
